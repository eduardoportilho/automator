...
// $ ./src/scripts/ynab-budget-tsv-to-sheets.ts '/Users/eduardoportilho/Downloads/ynab-budget.tsv' 2024/09
...
(async () => {
  try {
    const [path, month] = getArgs({
      requiredCount: 1,
      errorMessage: `Missing arguments. Usage: ynab-budget-tsv-to-sheets.ts <path/to/ynab-budget.tsv> <YYYY-MM>`,
    });
