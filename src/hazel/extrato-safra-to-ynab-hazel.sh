# Replaced by:
# source /Users/eduardoportilho/dev/personal/automator/src/hazel/run_automator_script.sh $1 extrato-safra-csv-to-ynab-post.ts BUDGET_EDU_2025 ACCOUNT_EDU_2025_SAFRA_CONTA_EDU YNAB_ACCESS_TOKEN
